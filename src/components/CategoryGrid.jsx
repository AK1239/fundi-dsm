  ...
  const categories = [
    {
      ...
      keywords: ["umeme", "electrician", "electric", "power", "wire", "electricity"],
      icon: (
        <svg
    ...
    },
    {
      ...
      keywords: ["vigae", "paving", "blocks", "flooring", "outdoor", "construction"],
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-10 w-10"
    ...
    },
    {
      ...
      name: "Fundi Rangi",
      description: "Painter",
      keywords: ["rangi", "painter", "paint", "wall", "color", "house"],
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-10 w-10"
    ...
    },
    {
      ...
      keywords: ["ac", "air conditioner", "cooling", "heating", "hvac", "technician", "repair"],
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-10 w-10"
    ...
    },
    {
      id: 7,
      name: "Fundi Dish",
      description: "Antenna Repair",
      keywords: ["dish", "antenna", "satellite", "tv", "signal", "repair"],
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-10 w-10"
    ...
    },
    {
      id: 9,
      name: "Fundi Simu",
      description: "Mobile Phone Technician",
    ...
    },
    {
      id: 10,
      name: "Fundi Network",
      description: "Telecommunication Technician",
      keywords: ["network", "telecommunication", "internet", "wifi", "technician"],
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-10 w-10"
